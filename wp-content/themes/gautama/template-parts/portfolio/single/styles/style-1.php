...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'sigma-portfolio-details' ); ?>>
		...
		<div class="sigma-portfolio-thumbnail">
			...
			<div class="sigma-portfolio-details">
				...
				<div class="sigma-portfolio-detail sigma-portfolio_phone-number">
					...
					<div class="sigma-portfolio-detail-title"><?php echo esc_html__( 'Project Name', 'gautama' ); ?></div>

					<div class="sigma-portfolio-detail-value"><?php the_title(); ?></div>
