...
?>
<article id="post-<?php the_ID(); ?>" <?php post_class('sigma-ministries sigma-ministries-style-2 sigma-ministries-wrapper'); ?>>
  <div class="sigma_ministries style-2 <?php echo esc_attr($wrapp_icon_class); ?>">
