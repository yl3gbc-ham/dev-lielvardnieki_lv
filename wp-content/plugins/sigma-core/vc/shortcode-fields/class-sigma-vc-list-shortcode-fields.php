...
class Sigma_Vc_List_Shortcode_Fields {
	...
	function shortcode_fields() {
		$fields = array(
			array(
				'type'        => 'dropdown',
				'heading'     => esc_html__( 'List Style', 'sigma-core' ),
				'param_name'  => 'style',
	...
	function shortcode_callback( $atts, $content = null, $handle = '' ) {
      ...
      'list_icon_color'     => '',
		...
		$sigma_shortcodes_classes .= ' list-' . $atts['style'];
		if ( $atts[ 'el_class' ] ) {
			$sigma_shortcodes_classes .= ' ' . $atts[ 'el_class' ];
		}

		// colors
		if ( $atts[ 'list_title_color' ] ) {
			$inline_css .= "." . $sigma_shortcodes_class_unique . ".sigma_list_wrapper.list-style-1 .sigma-list-wrapper ul li p { color: " . $atts[ 'list_title_color' ] . ";}";
			$inline_css .= "." . $sigma_shortcodes_class_unique . ".sigma_list_wrapper.list-style-1 .sigma-list-wrapper ul li p a { color: " . $atts[ 'list_title_color' ] . ";}";
			$inline_css .= "." . $sigma_shortcodes_class_unique . ".sigma_list_wrapper.list-style-2 ul li p { color: " . $atts[ 'list_title_color' ] . ";}";
		}
		if ( $atts[ 'list_icon_color' ] ) {
			$inline_css .= "." . $sigma_shortcodes_class_unique . ".sigma_list_wrapper.list-style-1 .sigma-list-wrapper ul li .sigma-list-icon i{ color: " . $atts[ 'list_icon_color' ] . ";}";
			$inline_css .= "." . $sigma_shortcodes_class_unique . ".sigma_list_wrapper.list-style-2 ul li i{ color: " . $atts[ 'list_icon_color' ] . ";}";
			$inline_css .= "." . $sigma_shortcodes_class_unique . ".sigma_list_wrapper.list-style-2 ul li i{ border-color: " . $atts[ 'list_icon_color' ] . ";}";
		}
