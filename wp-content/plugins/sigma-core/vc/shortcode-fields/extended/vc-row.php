...
if ( ! function_exists( 'sigmacore_extend_vc_row_fields' ) ) {
	...
	function sigmacore_extend_vc_row_fields() {
		...
		// Update the row fields with the extend ones.
