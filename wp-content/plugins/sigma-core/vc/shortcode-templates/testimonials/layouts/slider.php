...
?>
<div class="slick-slider testimonial-slider <?php echo esc_attr( sigmacore_get_slider_layout_classes($atts) ) ?>" data-slick="<?php echo esc_attr( json_encode( $slick_options ) ); ?>">
	<?php
