<?php
/**
 * Progress bar shortcode style 3 template file.
 *
 * @package sigma Core
 */
if ( ! defined( 'ABSPATH' ) ) {
	...
	foreach( $progress_bars as $progress_bar ){
		...
		<div class="sigma-progress-bar-wrapper">
			...
			<div class="sigma-progress-bar">
				<div class="sigma-progress-bar-inner" data-bar-value="<?php echo esc_attr( $width ); ?>">
          <span></span>
          <?php 	if ( isset( $progress_bar[ 'bar_value' ] )&& $progress_bar[ 'bar_value' ] && is_int( ( int ) $progress_bar[ 'bar_value' ] ) ) {
              ?>
