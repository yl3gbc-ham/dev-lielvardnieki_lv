<?php
/**
 * Blog shortcode style 3 template file.
 *
 * @package sigma Core
 */
if ( ! defined( 'ABSPATH' ) ) {
	...
	<div class="sigma-post-wrapper">
		...
		<div class="sigma-post-inner">
			<header class="entry-header">
				...
				<?php } ?>
				<?php
				if(function_exists('gautama_posted_on') && $atts['post_date'] == 'yes'){
					gautama_posted_on();
				}
				?>
			</header>
			...
			<footer class="entry-footer">
				<div class="post-read-more-link">
					<a href="<?php the_permalink(); ?>">
						<?php echo esc_html('Read More', 'sigma-core'); ?><i class="far fa-arrow-right"></i>
					</a>
				</div>
			</footer>
			<?php } ?>
